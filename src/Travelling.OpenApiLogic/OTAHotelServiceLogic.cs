...
namespace Travelling.OpenApiLogic
{
    ...
    public class OTAHotelServiceLogic
    {
        ...
        /// <param name="availRatesOnlyInd"></param>
        /// <returns></returns>
        public static HotelRatePlan OTA_HotelRatePlan(int hotelId, DateTime startDt, DateTime endDt, bool availRatesOnlyInd = true)
        {
            ...
            return rep.HotelRatePlanList[0];
        ...
        /// <param name="isPerRoom"></param>
        /// <returns></returns>
        public static OTA_HotelAvailReturnEntity HotelRoomBookAvaible(int hotelId, int roomTypeCode, int roomCount, int guestCount, DateTime checkinTime, DateTime checkoutDateTime, DateTime lastCheckInTime, bool? isPerRoom = null)
        {
            ...
            callEntity.CheckOutTime = checkoutDateTime;
