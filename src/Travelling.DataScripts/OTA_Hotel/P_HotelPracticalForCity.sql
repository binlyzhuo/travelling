...
@cityid int
as
select top 6 d.HotelID,d.HotelImg,d.HotelName,d.HotelCityCode,p.AmountBeforeTax,p.ListAmount,(p.ListAmount-p.AmountBeforeTax) as PriceDiff,d.CityName  from T_XC_HotelDescription d with(NOLOCK)
inner join T_XC_HotelPrice p WITH(NOLOCK) on d.HotelID = p.HotelID
